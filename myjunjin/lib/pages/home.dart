...
class AriticleLists extends StatefulWidget {
   final Map categories;

   @override
   AriticleLists({Key key,this.categories}) : super(key:key);

   AriticleListsState createState() => new AriticleListsState();

}

class AriticleListsState extends State<AriticleLists> {
   List articleList;
